...
void loop(void)
{
    ...
    */
    ...
    quat1.z() = -quat1.z();
    */
    //find transform matrix between shoulder and ref sensor
    imu::Matrix<3> matrix1 = quat1.toMatrix();
    ...
    */
    ...
    Serial.print("Transform of Shoulder:");
    Serial.print("W: ");
    Serial.print(trans.w(), 4);
    Serial.print(", X: ");
    Serial.print(trans.x(), 4);
    Serial.print(", Y: ");
    Serial.print(trans.y(), 4);
    Serial.print(", Z: ");
    ...
    //find transform matrix between elbow and ref sensor
    imu::Matrix<3> matrix3 = quat3.toMatrix();
